            ...
            ZStack {
                ...
                VStack(spacing:0) {
                    ...
                    VStack(spacing: 20) {
                        ...
                        // 🟢 CORREÇÃO: NavigationLink para a tela de Login
                        // Assumindo que 'LoginView' é a tela no arquivo CatadorTelaCadastroLoginBloco5
...
struct LocationMenuView: View {
    ...
    // Variável que recebera os dados do Backend no futuro
            ...
            ZStack {
                ...
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 30) {
                        ...
                        // Botão 1: COLETAR
                        NavigationLink(destination: SwiftUIView()) { // <--- PÁGINA 1
                            GeneratorButtonLabel(text: "COLETAR", iconName: "arrow.triangle.2.circlepath")
                        }
                        
                        
                        // Botão 2: DADOS
                        NavigationLink(destination: Bloco3()) { // <--- PÁGINA 2
                            GeneratorButtonLabel(text: "DADOS", iconName: "server.rack")
                        }
                        
                        
                        // Botão 3: COMPROVANTES
                        NavigationLink(destination: ComprovanteServicoViewBloco2()) { // <--- PÁGINA 3
